...
class mod_wiziq_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $wiziq_timezone_select = $mform->addElement('select', 'wiziq_timezone', get_string('vc_class_timezone', 'wiziq'), $vctime,array('class' => 'fitem_wiziq_timezone'));
        ...
        $mform->addelement('select', 'wiziq_recur_class_repeat_type', get_string('class_repeat_type', 'wiziq'), $class_repeat_type, array('class' => 'fitem_id_wiziq_recur_class_repeat_type')); // class_repeat_type
        $mform->addHelpButton('wiziq_recur_class_repeat_type', 'wiziq_recur_class_repeat_type', 'wiziq');

        $mform->addElement('text', 'specific_week', get_string('specific_week', 'wiziq'), array('size' => '20', 'class' => 'fitem_id_specific_week')); //specific week
        ...
        $mform->addelement('select', 'days_of_week', get_string('days_of_week', 'wiziq'), $days_of_week, array('class' => 'fitem_id_days_of_week')); //days_of_week
        ...
        $mform->addelement('select', 'select_monthly_repeat_type', get_string('select_monthly_repeat_type', 'wiziq'), $select_monthly_repeat_type, array('class' => 'fitem_id_select_monthly_repeat_type')); //repeat_type
        ...
        $mform->addelement('select', 'monthly_date', get_string('monthly_date', 'wiziq'), $monthly_date, array('class' => 'fitem_id_monthly_date')); //monthly_repeat
        ...
        $group = $mform->addGroup($class_schedule,'class_schedule', get_string('class_schedule', 'wiziq'), null , false); //class_schedule
        $group->setAttributes(array('class' => 'fitem_id_class_schedule'));
        $mform->addHelpButton('class_schedule', 'class_schedule', 'wiziq');

        $mform->addElement('text', 'class_occurrence', get_string('class_occurrence', 'wiziq'), array('size' => '20', 'class' => 'fitem_id_class_occurrence'));
        $mform->addHelpButton('class_occurrence', 'class_occurrence', 'wiziq');

        $date_select = $mform->addElement('date_selector', 'assesstimefinish', get_string('class_end_date', 'wiziq')); // end date
        $date_select->setAttributes(array('class' => 'fitem_id_assesstimefinish'));
    ...
    public function validation($data, $files) {
        ...
        if (optional_param('class_type',null,PARAM_RAW) == 0 || $data['class_type'] != 1) {
